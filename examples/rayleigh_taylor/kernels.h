...
namespace t8gpu {
  ...
  __global__ void compute_inner_fluxes(
      t8gpu::SubgridMemoryAccessorOwn<t8gpu::VariableList, t8gpu::SubgridCompressibleEulerSolver::subgrid_type>
          variables,
  ...
  __global__ void compute_refinement_criteria(typename t8gpu::SubgridCompressibleEulerSolver::subgrid_type::Accessor<
                                                  t8gpu::SubgridCompressibleEulerSolver::float_type> density,
