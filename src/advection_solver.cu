...
void advection_solver_t::iterate() {
  ...
  compute_fluxes<<<fluxes_num_blocks, thread_block_size>>>(thrust::raw_pointer_cast(device_element_variable_prev.data()),
							   thrust::raw_pointer_cast(device_element_fluxes.data()),
  ...
  explicit_euler_time_step<<<euler_num_blocks, thread_block_size>>>(thrust::raw_pointer_cast(device_element_variable_prev.data()),
								    thrust::raw_pointer_cast(device_element_variable_next.data()),
								    thrust::raw_pointer_cast(device_element_volume.data()),
								    thrust::raw_pointer_cast(device_element_fluxes.data()),
								    delta_t,
								    element_variable.size());
