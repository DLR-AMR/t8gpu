...
class SubgridCompressibleEulerSolver {
 public:
  ...
  using float_type                = t8gpu::variable_traits<VariableList>::float_type;
 ...
 private:
  ...
  t8gpu::SubgridMeshManager<VariableList, StepList, subgrid_type> m_mesh_manager;
...
#ifdef SOLVER_INCLUDE_IMPLEMENTATION
#include "solver.inl"
#endif
