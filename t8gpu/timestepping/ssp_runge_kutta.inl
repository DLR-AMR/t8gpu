...
__global__ void t8gpu::timestepping::SSP_3RK_step1(t8gpu::MemoryAccessorOwn<VariableType> prev,
						   ...
						   typename t8gpu::variable_traits<VariableType>::float_type delta_t, int num_elements) {
...
template<typename VariableType>
__global__ void t8gpu::timestepping::SSP_3RK_step2(t8gpu::MemoryAccessorOwn<VariableType> prev,
						   t8gpu::MemoryAccessorOwn<VariableType> step1,
...
template<typename VariableType>
__global__ void t8gpu::timestepping::SSP_3RK_step3(t8gpu::MemoryAccessorOwn<VariableType> prev,
						   t8gpu::MemoryAccessorOwn<VariableType> step2,
