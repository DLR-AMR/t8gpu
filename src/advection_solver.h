...
namespace t8gpu {
  ...
  private:
    ...
    t8gpu::shared_device_vector<double> device_element_variable_prev;
    t8gpu::shared_device_vector<double> device_element_variable_next;
    t8gpu::shared_device_vector<double> device_element_fluxes;
    t8gpu::shared_device_vector<double> device_element_volume;
